...
export default function VicePresidentDetailsStep() {
  const navigate = useNavigate()
  const { formData, updateVicePresident } = useTempleFormContext()
  const [localData, setLocalData] = useState(formData.vicePresident)
  ...
  const handleBack = () => navigate('/temple-registration/president')

  const handleNext = () => {
    updateVicePresident(localData)
    navigate('/temple-registration/review')
  }
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 space-y-4">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Vice-President Details</h2>
          </div>
